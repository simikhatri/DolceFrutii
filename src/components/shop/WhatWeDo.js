                            ...
                            <div className="working ">
                                ...
                                <div className="content text-start">
                                    ...
                                    <p>The most sustainable form of agriculture that prioritizes the use of natural processes is organic
                                        farming. Central to our organic farming principles is our emphasis on soil... <Link to="/about">Read More</Link></p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 p-0">
                            <div className="working">
                                ...
                                <div className="content text-start">
                                    ...
                                    <p>The meticulous process of harvesting fruit while still ensuring the preservation of flavor,
                                        texture, and quality of the fruit requires that you time the harvest appropriately...<Link to="/about">Read More</Link> </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 p-0">
